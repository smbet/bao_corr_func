...
result_mocks = TwoPointCorrelationFunction('smu', edges, data_positions1=d_pos, randoms_positions1=r_pos, engine='corrfunc', nthreads=ncpu)
result_mocks.save('cor_func_nojac_'+subfrac+'.npy')
