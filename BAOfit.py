...
Has the functions that baofitscript calls to actually do the bao fitting - SB
'''
...
def mkxivec_3dewig(rl,v='n',mun=0,beta=0.4,sfog=0,sigz=0,sigt=6.,sigr=10.,sigs=10.):
    '''
...
def pk3elldfile_dewig(beta=0.4,sigt=3.0,sigr=3.0,sfog=3.0,mun=1.,sigs=15.,sigz=0,pw='n'):
    '''
    ...
    cosmo = DESI(h=0.6774,Omega_cdm=0.2589,Omega_b=0.05,sigma8=0.8159)
